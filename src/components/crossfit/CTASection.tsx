    ...
    <section className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 lg:px-8 text-center">
        ...
        <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer">
          <Button className="bg-[#25D366] hover:bg-[#20bd5a] text-white font-display text-lg md:text-xl font-bold uppercase tracking-wide px-12 py-6 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
