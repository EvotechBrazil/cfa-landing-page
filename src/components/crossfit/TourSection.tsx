  ...
  return (
    <section id="tour" className="section-padding bg-card">
      <div className="container-custom mx-auto">
        ...
        {/* Video Placeholder */}
        <div className="relative aspect-video bg-secondary rounded-xl overflow-hidden border border-border mb-6">
          <div className="absolute inset-0 flex items-center justify-center">
            <button className="w-16 h-16 bg-primary rounded-full flex items-center justify-center shadow-glow hover:scale-110 transition-transform">
              <Play className="w-6 h-6 text-primary-foreground ml-0.5" />
            </button>
          </div>
          <div className="absolute bottom-0 left-0 right-0 p-5 bg-gradient-to-t from-background to-transparent">
            <h3 className="font-display text-lg font-bold text-foreground">Tour Virtual pelo Box</h3>
            <p className="text-sm text-muted-foreground">Veja nossa estrutura em ação</p>
          </div>
        </div>
