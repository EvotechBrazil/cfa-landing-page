...
const WHATSAPP_LINK =
  "https://wa.me/5543991796835?text=Olá! Gostaria de mais informações sobre a CrossFit Arapongas.";
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="flex items-center justify-center gap-4 mt-12">
          <a
            ...
            aria-label="Instagram CrossFit Arapongas"
          >
          ...
          <a
            ...
            rel="noopener noreferrer"
            className="w-14 h-14 bg-card border border-border rounded-full flex items-center justify-center hover:border-primary hover:bg-primary/10 transition-all duration-300"
            aria-label="Facebook CrossFit Arapongas"
          >
